...
DEFAULT_SYNC_ALL_STOCK_ID_PATTERN='^\d+[A-Z]?$'
DEFAULT_SYNC_COMPANY_STOCK_ID_PATTERN='^\d{4}$'
SYNC_ALL_STOCK_ID_PATTERN="${SYNC_ALL_STOCK_ID_PATTERN:-$DEFAULT_SYNC_ALL_STOCK_ID_PATTERN}"
SYNC_COMPANY_STOCK_ID_PATTERN="${SYNC_COMPANY_STOCK_ID_PATTERN:-$DEFAULT_SYNC_COMPANY_STOCK_ID_PATTERN}"
